...
export const ADMIN_NAV: readonly AdminNavEntry[] = [
  {
    ...
    children: [
      { path: 'resumen', label: 'Resumen general', allowedRoles: ['ROLE_ADMIN'] },
  ...
  },
  {
    ...
    icon: 'tag',
    path: 'precios',
    allowedRoles: ['ROLE_ADMIN', 'ROLE_EMPLOYEE', 'ROLE_PATIENT'],
    children: [
      { path: 'citas', label: 'Citas', allowedRoles: ['ROLE_ADMIN', 'ROLE_EMPLOYEE'] },
      { path: 'paquetes', label: 'Paquetes', allowedRoles: ['ROLE_ADMIN', 'ROLE_EMPLOYEE', 'ROLE_PATIENT'] },
      { path: 'sesiones', label: 'Sesiones', allowedRoles: ['ROLE_ADMIN', 'ROLE_EMPLOYEE', 'ROLE_PATIENT'] },
      { path: 'descuentos', label: 'Descuentos', allowedRoles: ['ROLE_ADMIN', 'ROLE_EMPLOYEE', 'ROLE_PATIENT'] },
      { path: 'promociones', label: 'Promociones', allowedRoles: ['ROLE_ADMIN', 'ROLE_EMPLOYEE', 'ROLE_PATIENT'] },
    ],
  },
  {
    id: 'bloqueo',
